...
imgitm=ImageTk.PhotoImage(Image.open('/home/parsa/icons/itb.png').resize((40,40), Image.ANTIALIAS))
...
imgon=ImageTk.PhotoImage(Image.open('/home/parsa/icons/toggleon.png').resize((40,40), Image.ANTIALIAS))
imgimn=ImageTk.PhotoImage(Image.open('/home/parsa/icons/togglein.png').resize((40,40), Image.ANTIALIAS))
imgoff=ImageTk.PhotoImage(Image.open('/home/parsa/icons/toggleoff.png').resize((40,40), Image.ANTIALIAS))
######################## var #########################
everysongs=[]
songs_shuffle=[]
playlistsong=[]
